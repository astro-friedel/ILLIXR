...
function(generate_yaml)
    ...
    if($CACHE{LAST_YAML_BUILD} LESS ${PROFILE_FILE_TIMESTAMP})
        ...
        foreach(LINE_ITEM IN LISTS YAML_LINES)
            ...
            set(ALL_FILE "${PROJECT_SOURCE_DIR}/profiles/unit-tests.yaml")
...
macro(add_test plugin_name)
    ...
    if(ENABLE_COVERAGE)
        append_coverage_compiler_flags_to_target(test_${plugin_name})
        append_coverage_compiler_flags_to_target(${plugin_name})
        list(APPEND COVERAGE_DEPENDENCIES test_${plugin_name})
