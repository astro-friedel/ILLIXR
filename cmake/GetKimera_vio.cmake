...
ExternalProject_Add(Kimera_VIO
        ...
        GIT_TAG 1817d6bc309c2c31379767f45c27403f81342b7a          # sha5 hash for specific commit to pull (if there is no specific tag to use)
        ...
        CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_SHARED_LINKER_FLAGS=-L${CMAKE_INSTALL_PREFIX}/lib -DCMAKE_EXE_LINKER_FLAGS=-L${CMAKE_INSTALL_PREFIX}/lib -DKIMERA_BUILD_TESTS=OFF -DILLIXR_BUILD_SUFFIX=${ILLIXR_BUILD_SUFFIX} -DCMAKE_INSTALL_LIBDIR=lib -DILLIXR_ROOT=${CMAKE_SOURCE_DIR}/include ${KIMERA_VIO_CMAKE_ARGS}
        )
