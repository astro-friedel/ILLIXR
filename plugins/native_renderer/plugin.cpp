...
native_renderer::native_renderer(const std::string& name_, phonebook* pb)
        : threadloop{name_, pb}
 ...
 */
void native_renderer::create_depth_image(VkImage* depth_image, VmaAllocation* depth_image_allocation, VkImageView* depth_image_view) {
