...
// ********************************************************************
pose_type faux_pose_impl::get_true_pose() const {
    throw std::logic_error{"Not Implemented"};
}

// ********************************************************************
bool faux_pose_impl::fast_pose_reliable() const {
    return true;
}

// ********************************************************************
bool faux_pose_impl::true_pose_reliable() const {
    return false;
}
...
// ********************************************************************
/* Constructor: Provide handles to faux_pose */
faux_pose::faux_pose(const std::string& name, phonebook* pb)
        : plugin{name, pb} {
